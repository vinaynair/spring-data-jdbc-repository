...
public abstract class BaseJdbcRepository<T, ID extends Serializable>
     ...
     * called with a new entity. Override this method e.g. if you want to
     * fetch auto-generated key(s) from database.
     *
     * @see #postInsert(Object, Object)
     * @param entity The entity that was passed to {@link #insert}.
     * @param generatedKeys Map of keys generated during INSERT (with column
     *        name as a map key), or an empty map if no key was generated.
     * @return Either the same object as an argument or completely different one.
     */
    protected <S extends T> S postInsert(S entity, Map<String, Object> generatedKeys) {
        Object key = generatedKeys.isEmpty() ? null : generatedKeys.values().iterator().next();

        return postInsert(entity, key);
    }

    /**
     * @see #postInsert(S, Map)
     * @param entity The entity that was passed to {@link #insert}.
     * @param generatedKey The key generated during INSERT, or null if no key
     *        was generated.
     * @return Either the same object as an argument or completely different one.
     */
    protected <S extends T> S postInsert(S entity, Object generatedKey) {
        return entity;
    }
    ...
    private <S extends T> S insertWithManuallyAssignedKey(S entity, Map<String, Object> columns) {
        ...
        return postInsert(entity, Collections.<String, Object>emptyMap());
    }
    ...
    private <S extends T> S insertWithAutoGeneratedKey(S entity, Map<String, Object> columns) {
        ...
        jdbcOps.update(new PreparedStatementCreator() {
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                String[] idColumnNames = toStringArray(table.getPkColumns());
                PreparedStatement ps = con.prepareStatement(insertQuery, idColumnNames);
